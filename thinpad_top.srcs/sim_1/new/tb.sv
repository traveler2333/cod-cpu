...
module tb;
  ...
  // parameter BASE_RAM_INIT_FILE = "D:\\aaa_code\\classes\\cs_lab\\LABS\\rv-2024\\supervisor-rv\\kernel\\kernel.bin"; // BaseRAM 初始化文件，请修改为实际的绝对路??
  parameter BASE_RAM_INIT_FILE = "D:\\aaa_code\\classes\\cs_lab\\LABS\\rv-2024\\asmcode\\a.bin"; // BaseRAM 初始化文件，请修改为实际的绝对路??
  parameter EXT_RAM_INIT_FILE = "/tmp/eram.bin";  // ExtRAM 初始化文件，请修改为实际的绝对路??
  parameter FLASH_INIT_FILE = "";  // Flash 初始化文件，请修改为实际的绝对路??
  ...
  initial begin
    ...
    for (integer i = 0; i < 20; i = i + 1) begin
      ...
      #10000;
      uart.pc_send_byte(8'h42);  
      #10000;
      uart.pc_send_byte(8'h43);  
      #10000;
      uart.pc_send_byte(8'h44);  
      #10000;
      uart.pc_send_byte(8'h45);  
      #10000;
      uart.pc_send_byte(8'h46);  
      #10000;
      uart.pc_send_byte(8'h47);  
      #10000;
      uart.pc_send_byte(8'h48);  
      #10000;
      uart.pc_send_byte(8'h49);  
      #10000;
      uart.pc_send_byte(8'h4A);  
      #10000;
      uart.pc_send_byte(8'h4B);
      #10000;
      uart.pc_send_byte(8'h4C);
      #10000 $finish;
